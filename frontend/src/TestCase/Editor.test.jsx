...
describe("Javascript Component",()=>{
    ...
    test('Should Download the Code:',()=>{
      ...
      expect(downloadLink).toHaveAttribute('href', expect.stringContaining('codify-'));
      expect(downloadLink).toHaveAttribute('download', expect.stringContaining('codify-'));
    })
})
...
//         // const textEle = screen.getByText("")

//         //regrex text matching query
//         // const textEle = screen.getByText(//i)     //substring match,ignore case
//         // const textEle = screen.getByText(/^$/i)       //substring match,ignore case
